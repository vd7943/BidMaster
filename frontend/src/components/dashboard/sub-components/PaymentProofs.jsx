                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="flex items-center py-4 justify-center gap-3">
                      ...
                      <button
                        className="bg-red-600 text-white py-1 px-3 rounded hover:bg-red-700 transition-all duration-300"
...
export const Drawer = ({ setOpenDrawer, openDrawer }) => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white w-full transition-all duration-300 min-h-[80%] max-h-full overflow-auto">
